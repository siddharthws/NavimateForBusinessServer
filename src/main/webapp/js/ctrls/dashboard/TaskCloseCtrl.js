...
app.controller("TaskCloseCtrl", function ($scope, $rootScope, $http, $localStorage, $state, DialogService, ToastService ,TaskDataService, LeadDataService, TeamDataService, TemplateDataService) {
    var vm = this
