...
app.controller('TableOldCtrl', function ($scope, $rootScope, $state, $window, $filter, NgTableParams,
                                         ExcelService, DialogService, ToastService) {
    var vm = this
    ...
    function toggleColumns () {
        DialogService.toggleColumnsOld(vm.columns, function (columns) {
            vm.columns = columns
        })
    }
